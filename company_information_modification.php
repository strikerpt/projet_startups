...
if(isset($_GET['company_name']))
{
    ...
    <div class="container">
        ...
        <form method="post" class="form_change_startup col-12 col-sm-12 col-lg-8 col-xl-8 my-5" action="'; echo security_text($_SERVER["PHP_SELF"])."?company_name=".$_GET["company_name"]; echo'">
