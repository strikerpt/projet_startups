                    ...
                    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $uploadfile)) 
                    {
                        ...
                        while(($data = fgetcsv($input, 5000, ",")) !== FALSE)
                        {
                            ...
                            while (($csv = fgetcsv($input, 5000, ",")) !== FALSE) 
                            {
                                ...
                                $import_data_to_db = $db -> prepare('INSERT INTO startup_test(company,founding_year,web,rc,exit_year,time_to_exit,capital,innogrant,prix_pre_seed,impact,key_words,ba_ma_phd_epfl,founders_origin,founders_country,name,firstname,function,email,email1,linkedin,name2,firstname2,function2,gender_female_ratio,gender_female_number,fac_dpt,laboratory,prof,investment_2020,investor_2020,description,fk_status,fk_type,fk_sectors) VALUES ("'.$csv[0].'","'.$csv[1].'","'.$csv[2].'","'.$csv[3].'","'.$csv[5].'","'.$csv[6].'","'.$csv[8].'","'.$csv[9].'","'.$csv[10].'","'.$csv[11].'","'.$csv[13].'","'.$csv[14].'","'.$csv[15].'","'.$csv[16].'","'.$csv[17].'","'.$csv[18].'","'.$csv[19].'","'.$csv[20].'","'.$csv[21].'","'.$csv[22].'","'.$csv[23].'","'.$csv[24].'","'.$csv[25].'","'.$csv[26].'","'.$csv[27].'","'.$csv[28].'","'.$csv[29].'","'.$csv[30].'","'.$csv[31].'","'.$csv[32].'", "'.$csv[33].'", "'.$csv[4].'","'.$csv[7].'","'.$csv[12].'")');
